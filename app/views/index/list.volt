            ...
            <div class="col-xs-12">
                ...
                <div class="list-article">
                    <div class="card-columns">
                        {% for article in data['list'] %}
                        <div class="card">
                            <img class="card-img-top hidden-md-down" src="https://placeholdit.imgix.net/~text?txtsize=33&txt=242%C3%97150&w=242&h=150" data-src="https://placeholdit.imgix.net/~text?txtsize=33&txt=350%C3%97150&w=300&h=150" alt="{{ article['title'] }}">
